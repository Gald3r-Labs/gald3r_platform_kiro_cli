...
This project runs on **[Gald3r](https://github.com/wrm3/gald3r) for Kiro CLI** -- file-based
...
Open this project in **Kiro CLI** and run **`@g-setup`** -- it initializes gald3r and fills in
